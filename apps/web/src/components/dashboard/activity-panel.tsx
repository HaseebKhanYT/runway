...
import {ACTIVITY_EMPTY} from '../../lib/empty-states';
  ...
  return (
    <div className={ui.card}>
      ...
      <div>
        {state.txns.length === 0 ? (
          <>
            <div style={{fontSize: 12.5, color: 'var(--muted)'}}>{ACTIVITY_EMPTY.line}</div>
            {/* A button, not a link: what fills this list is a modal, not a route. */}
            <button
